...
const SingleOrder = ({ params }) => {
  ...
  if (!isLoading && !isError) {
    ...
    content = (
      <section className="invoice__area pt-40 pb-120">
              ...
              <div className="col-xl-12">
                <div className="invoice_msg mb-40">
                  <p className="text-black alert alert-success">
                    Cảm ơn <strong>{name}</strong>. Đơn đặt hàng của bạn đã được nhận!
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                ...
                <div className="col-md-6 col-sm-4">
                  <div className="invoice__details mt-md-0 mt-20 text-md-end">
                    <p className="mb-0">
                      <strong>ID hóa đơn:</strong> #{invoice}
                    </p>
                    <p className="mb-0">
                      <strong>Ngày:</strong>{" "}
              ...
              <div className="row">
                <div className="col-lg-3 col-md-4">
                  <div className="invoice__payment-method mb-30">
                    ...
                    <p className="tp-font-medium text-uppercase">
                      {cardInfo?.type ? cardInfo.type : "Thanh toán khi nhận hàng"}
                    </p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4">
                  <div className="invoice__shippint-cost mb-30">
                    <h5 className="mb-0">Phí giao hàng</h5>
                ...
                <div className="col-lg-3 col-md-4">
                  <div className="invoice__discount-cost mb-30">
                    ...
                    <p className="tp-font-medium">{discount.toFixed(0)}đ</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4">
                  <div className="invoice__total-ammount mb-30">
                    ...
                    <p className="tp-font-medium text-danger">
                      <strong>{totalAmount.toFixed(0)}đ</strong>
                    </p>
                  </div>
                </div>
              </div>
