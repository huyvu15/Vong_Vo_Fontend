...
const award_data = [
  {
    id: "one",
    topic: "MIỄN PHÍ VẬN CHUYỂN",
    title: "Mua hàng không lo phí vận chuyển",
    data_src: award_img_1,
    subtitle: "Áp dụng cho đơn hàng đủ điều kiện",
    delay: ".3s",
  },
  {
    id: "two",
    topic: "HOÀN TRẢ MIỄN PHÍ",
    title: "Hoàn trả hoàn toàn miễn phí khi có bất kỳ lỗi gì",
    data_src: award_img_2,
    subtitle: "Áp dụng khi lỗi phía bên chúng tôi",
    delay: ".5s",
  },
  {
    id: "three",
    topic: "THANH TOÁN AN TOÀN",
    title: "Thanh toán qua thẻ tín dụng an toàn",
    data_src: award_img_3,
    subtitle: "An toàn qua bên thứ ba",
    delay: ".7s",
  },
  {
    id: "four",
    topic: "CHẤT LƯỢNG TỐT NHẤT",
    title: "Chất lượng sản phẩm luôn là ưu tiên",
          ...
          <div className="row">
            <div className="col-xxl-12">
              <div className={`section__title-wrapper-9 mb-55 text-center`}>
                <h3 className="section__title-9">Ưu đãi.</h3>
              </div>
            </div>
          </div>
          <div className="row">
